...
zip ${GITHUB_WORKSPACE}/SmokeTest.zip $(find /Users/runner/Library/Developer/Xcode/DerivedData/SplunkRumWorkspace/Build/Products/Debug-iphonesimulator/SmokeTest.app -type f)
pwd
