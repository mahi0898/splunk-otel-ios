...
xcodebuild -workspace SplunkRumWorkspace/SplunkRumWorkspace.xcworkspace -scheme SmokeTest -configuration Debug test -destination 'platform=iOS Simulator,name=iPhone 12 Pro,OS=${{ matrix.ios }}'
